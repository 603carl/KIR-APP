        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="h-10 w-10 rounded-full bg-severity-low/20 flex items-center justify-center">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="h-10 w-10 rounded-full bg-severity-medium/20 flex items-center justify-center">
                <Clock className="h-5 w-5 text-severity-medium" />
              </div>
            </div>
            <div className={`flex items-center gap-1 mt-2 ${stats.trend.total > 0 ? 'text-severity-low' : 'text-severity-medium'}`}>
