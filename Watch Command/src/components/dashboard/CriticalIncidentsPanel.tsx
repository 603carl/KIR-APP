...
export function CriticalIncidentsPanel({ incidents, isLoading = false }: CriticalIncidentsPanelProps) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {isLoading ? "Fetching latest data..." : `${incidents.length} requiring immediate attention`}
            </p>
          </div>
        </div>
        <Button
